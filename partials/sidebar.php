<div class="sidebar">
  ...
  <button type="button" id="search"><img src="images/search.png"></button><br>
  ...
  <button type="button" class="side-button" name="settings" onclick="sidebarClick('maintenance')">Maintenance</button><br>
